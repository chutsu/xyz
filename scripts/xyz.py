...
#     self.tag_size = kwargs.get("tag_size", 0.1)
#     self.tag_spacing = kwargs.get("tag_spacing", 0.3)
#
#   def object_point(self, tag_id, corner_index):
...
#     else:
#       raise RuntimeError(f"Invalid {tag_id=}, corner_index: {corner_index=}")
#
#   def object_points(self):
#     data = defaultdict(dict)
#     for tag_id in range(self.tag_rows * self.tag_cols):
#       for corner_index in range(4):
#         data[tag_id][corner_index] = self.object_point(tag_id, corner_index)
#     return data
